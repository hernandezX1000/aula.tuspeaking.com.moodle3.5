...
<?php elseif ($seccion == 'empresas'): ?>
        ...
        while ($e = $empresas_config->fetch_assoc()) {
            ...
            // Determinar tabla de clases según empresa
            if ($dominio == 'cesce.es') {
            ...
            $r_clases = $conn->query($sql_clases)->fetch_assoc();
            ...
            $r_fb = $conn->query($sql_fb)->fetch_assoc();
            ...
            $empresas_data[] = [
                ...
                'total_alumnos' => $r_clases['alumnos'] ?: 0,
                'total_clases' => $r_clases['clases'] ?: 0,
