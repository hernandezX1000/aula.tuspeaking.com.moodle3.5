...
<?php elseif ($seccion == 'auditoria'): ?>
        ...
        <div class="kpis">
            <div class="kpi <?=$cron_activo ? 'success' : 'danger'?>">
                ...
                <div class="kpi-sub"><?=$cron_activo ? "Último: ".date("d/m H:i", $cron_log_time) : "Sin ejecución reciente"?></div>
            </div>
