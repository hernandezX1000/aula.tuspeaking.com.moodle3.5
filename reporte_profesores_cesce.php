...
if (isset($_POST['generar'])) {
    ...
    $script = '/var/www/html/app/moodle/reportes_cesce/generar_reporte_profesores.sh';
    ...
    if (file_exists($script)) {
        ...
        if ($return_var === 0) {
            $archivo_esperado = "/var/www/html/app/moodle/reportes_cesce/Reporte_Profesores_CESCE_{$fecha_inicio}_a_{$fecha_fin}_formato.xlsx";
