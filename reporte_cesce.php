<?php
/**
 * Reporte de Asistencia CESCE - Interfaz Web
 */
...
<header>
    <div class="header-content">
        ...
        <h2><i class="fas fa-chart-bar"></i> Reporte Asistencia CESCE - Alumnos</h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="info-box">
                ...
                <ul>
                    <li><strong>Resumen Asistencia:</strong> Clases previstas y asistidas por mes por empleado</li>
                    <li><strong>Asistencia por Grupos:</strong> Detalle mensualizado por grupo con resumen global</li>
