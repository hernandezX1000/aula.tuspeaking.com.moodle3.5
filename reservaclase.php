...
<head>
    <meta charset="UTF-8">
    <title>Petici&oacute;n de reserva de clases</title>
...
<body>
	<div class="row">
        ...
        <div class="col-sm-6"><br /><br /><h2 style="color: rgb(85,85,85)"><strong>Petici&oacute;n de reserva de clases</strong></h2></div>
        <div class="col-sm-1"></div>
    </div>
    <hr />
    <div class="row">
    	...
    	<div class="col-sm-10">
<?php
$empresa = $_POST["empresaApunta"];
$para = "soporte.tuspeaking@gmail.com";
$asunto = "Solicitud de reserva de clases";
$nombre = $_POST["nombreReserva"];
$correo = $_POST["correoReserva"];
$profesor = $_POST["nombreProfeReserva"];
$hora = $_POST["horaReserva"];
$header = 'From: Moodle aula.tuspeaking.com' . "\r\n" . 'X-Mailer: PHP/' . phpversion();

$message = "El trabajador con nombre " . $nombre . " con correo electrónico " . $correo . ", ha solicitado un clase con el profesor ". $profesor . ", el próximo: " . $hora ;
