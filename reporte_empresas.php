<?php
/**
 * Reporte de Asistencia Empresas - Interfaz Web
 */
...
$empresas = array(
    ...
    'GKN' => 'GKN',
    'TEKIA' => 'Tekia',
    'TORRES_CARRERA' => 'Torres y Carrera',
    'BABEL' => 'Babel Group',
    'LIN3S' => 'Lin3s',
    'SODENA' => 'Sodena',
    'BEMOBILE' => 'Bemobile',
    'SERVIGUIDE' => 'Serviguide',
    'NETTRIM' => 'Nettrim/Attrim',
    'E2Y' => 'E2Y Commerce',
    'OHMYBOX' => 'Oh My Box'
);
...
if (isset($_POST['generar'])) {
    $empresa = isset($_POST['empresa']) ? $_POST['empresa'] : 'TODAS';
    ...
    $script = '/home/aulatuspeaking/www/app/moodle/reportes_cesce/reporte_asistencia_empresas.py';
    
    if (file_exists($script)) {
        $cmd = "cd /home/aulatuspeaking/www/app/moodle/reportes_cesce && PYTHONPATH=/home/aulatuspeaking/.local/lib/python3.9/site-packages /usr/bin/python3 " . escapeshellarg($script) . " " . escapeshellarg($empresa) . " " . escapeshellarg($fecha_inicio) . " " . escapeshellarg($fecha_fin) . " 2>&1";
        ...
        if ($return_var === 0) {
            if (preg_match('/Reporte:\s*(.+\.xlsx)/', $output_text, $matches)) {
                $archivo_generado = trim($matches[1]);
...
<head>
    ...
    <title>Reporte Asistencia Empresas | tuSpeaking</title>
    <style>
        :root {
            --tus-primary: #008ba3;
...
<header>
    <div class="header-content">
        ...
        <h2><i class="fas fa-chart-bar"></i> Reporte Asistencia Empresas</h2>
...
<main>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="info-box">
                <strong><i class="fas fa-info-circle"></i> Contenido del reporte (3 hojas):</strong>
                <ul>
                    <li><strong>Resumen Asistencia:</strong> Clases previstas y asistidas por mes</li>
                    <li><strong>Asistencia por Grupos:</strong> Detalle mensualizado por grupo</li>
                    <li><strong>Detalle Zoom:</strong> Registros individuales de cada clase</li>
                </ul>
                <div class="leyenda">
                    <span class="verde">✓ OK ≥ 75%</span>
                    <span class="amarillo">⚠ Regular 50-74%</span>
                    <span class="rojo">✗ Bajo &lt; 50%</span>
                </div>
            </div>
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <select name="empresa" class="form-control" required>
                        <?php foreach ($empresas as $key => $nombre): ?>
                        <option value="<?php echo $key; ?>" <?php if (isset($_POST['empresa']) && $_POST['empresa'] == $key) echo 'selected'; ?>><?php echo htmlspecialchars($nombre); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            ...
            <div class="periodos">
                ...
                <p>• Edición 25.2: 2025-09-01 a 2025-12-31</p>
                <p>• Edición 26.1: 2026-01-01 a 2026-06-30</p>
            </div>

            <div class="nav-links">
                <a href="reporte_cesce.php"><i class="fas fa-file-alt"></i> Reporte CESCE</a>
