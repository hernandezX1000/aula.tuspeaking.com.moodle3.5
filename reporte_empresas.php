...
if (isset($_POST['generar'])) {
    ...
    $script = '/var/www/html/app/moodle/reportes_cesce/reporte_asistencia_empresas.py';
    
    if (file_exists($script)) {
        $cmd = "cd /var/www/html/app/moodle/reportes_cesce && PYTHONPATH=/home/aulatuspeaking/.local/lib/python3.9/site-packages /usr/bin/python3 " . escapeshellarg($script) . " " . escapeshellarg($empresa) . " " . escapeshellarg($fecha_inicio) . " " . escapeshellarg($fecha_fin) . " 2>&1";
